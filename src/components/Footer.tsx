          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name}>
                  <Link href={item.href} className="text-white/60 hover:text-secondary transition-colors flex items-center gap-2 group text-xs font-black uppercase tracking-widest">
